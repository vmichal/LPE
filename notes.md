...
V kolektoru je v sérii èervená LED a 470R do zemì. Pouité zapojení je vlevo na schématu zapùjèeném ze zadání, na port STM32_Px.x
...
Obdélníkovı vstup: kanál 1 je báze, kanál 2 je kolektor, kanál 3 je napìtí na rezistoru v kolektoru, které je úmìrné tekoucímu proudu.
Je zajímavé, e i pøes nulovı proud kolektorem je spádná hrana napìtí U<sub>c</sub> pomalá. To je projev saturace LEDky, u které se vybíjí
...
Threshold voltage U<sub>TO</sub> je cca 1.9 V, kdy je U<sub>gs</sub> niší, není MOSFET otevøen vùbec a neteèe proud drainem.
Od pøiblinì 2.5V dál je MOSFET saturován a pøi dalším navyšování U<sub>gs</sub> ji proud neroste, protoe jej omezuje 
...
**POZOR** Na zajištìní definované úrovnì gatu MOSFETu! Bìhem resetu èi utrení vodièe bude vstup na gate
v Hi-Z, take bude tranzistor dìlat nepøedvídatelné kraviny. U BJT toto není takovı problém, protoe tam 
musí pøes bázi téci proud a ten otevøenım obvodem nepoteèe.
